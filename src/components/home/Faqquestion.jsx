...
const FAQSection = () => {
  ...
  return (
    <div className="w-[95%] lg:w-full max-w-[1206px] mt-6 md:mt-[32px] mx-auto bg-white rounded-[16px] md:rounded-[20px] p-5 sm:p-8 md:p-12 shadow-sm border border-gray-50">
      ...
      {/* Header */}
      <h2 className="text-[28px] sm:text-[36px] md:text-[52px] font-semibold text-[#222222] mb-6 md:mb-8 tracking-tight leading-tight">
          ...
          return (
            ...
            >
              ...
              >
                ...
                <span className="text-[15px] sm:text-[16px] md:text-[20px] font-semibold text-[#222222] pr-4 sm:pr-8 leading-snug">
                  {faq.question}
                </span>

                <div className="text-[#901C27] flex-shrink-0">
                  {isOpen ? (
              ...
              {isOpen && (
                <div className="mt-3 md:mt-4 pr-4 md:pr-12">
                  <p className="text-[13px] sm:text-[14px] md:text-[18px] text-[#222222CC] leading-[1.6] md:leading-[1.7]">
                    {faq.answer}
                  </p>
                </div>
              )}
