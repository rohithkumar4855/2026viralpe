  ...
  return (
    <div className="w-[95%] lg:w-full max-w-[1206px] mx-auto mt-6 md:mt-[32px] min-h-auto lg:min-h-[747px] bg-white rounded-[20px] shadow-sm flex flex-col lg:flex-row relative overflow-hidden lg:overflow-visible">
      ...
      <div className="w-full lg:max-w-[558px] p-6 sm:p-8 lg:p-5 flex flex-col justify-center items-center lg:items-start text-center lg:text-left z-10 ml-0 lg:ml-[54px] mt-4 lg:mt-0">
        ...
        <h2 className="text-[28px] sm:text-[40px] md:text-[52px] font-semibold text-[var(--text-dark)] tracking-tight mb-4 md:mb-6 leading-tight">
          Why Choose <span className="text-[var(--primary-red)]">ViralPe</span>?
        </h2>

        <p className="text-[14px] sm:text-[18px] md:text-[20px] lg:text-[24px] text-[var(--text-light)] mb-6 md:mb-8 tracking-tight leading-snug">
        ...
        <div className="flex flex-wrap justify-center lg:justify-start gap-2 sm:gap-3 mb-8 md:mb-10">
          ...
          <div className="flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-1.5 sm:py-2 bg-[#FCF0F1] text-[var(--primary-red)] rounded-full text-[11px] sm:text-[13px] font-bold border border-red-50">
        ...
        {/* Button */}
        <button className="button-class w-full max-w-[164px] text-white font-bold text-[16px] md:text-[20px] py-2 md:py-3 rounded-[8px] shadow-sm hover:bg-[#7a1620] transition-colors">
          Start Recharge
        </button>
